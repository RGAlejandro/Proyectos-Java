...
public class Libro {
	...
	public Libro(String titulo, String autor, String editorial, String isbn) throws IsbnException, CampoNuloException {
		super();
	...
	public Libro(int idlibros,String titulo, String autor, String editorial, String isbn, boolean prestado, LocalDate fechaPrestamo,
			LocalDate fechaDevolucion, LocalDateTime fechaAlta) throws IsbnException, CampoNuloException {
		super();
	...
	public void setTitulo(String titulo) throws CampoNuloException {
		if(titulo.length()==0) throw new CampoNuloException();
		this.titulo = titulo;
	}
	public String getAutor() {
		return autor;
	}
	public void setAutor(String autor) throws CampoNuloException {
		if(autor.length()==0) throw new CampoNuloException();
		this.autor = autor;
	}
	public String getEditorial() {
		return editorial;
	}
	public void setEditorial(String editorial) throws CampoNuloException {
		if(editorial.length()==0) throw new CampoNuloException();
		this.editorial = editorial;
	}
	public String getIsbn() {
		return isbn;
	}
	public void setIsbn(String isbn) throws IsbnException, CampoNuloException {
		if(isbn.length()==0) throw new CampoNuloException();
		if(!compruebaIsbn(isbn))throw new IsbnException("Isbn incorrecto");
		this.isbn = isbn;
	}
